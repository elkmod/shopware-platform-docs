...
1. [The first part of this guide provides basic examples to match the guide for service decorations mentioned above](730-add-plugin-cookies.md#code-examples-to-follow-along-the-service-decoration-guide)
2. [The second part explains, how you can listen for cookie consent changes via JavaScript](730-add-plugin-cookies.md#reacting-to-cookie-configuration-changes-via-javascript) 
3. [The third part takes a closer look at the cookie object itself](730-add-plugin-cookies.md#cookie-object) 

## Code examples to follow along the _service decoration_ guide
...
The cookie objects used in [part 1](730-add-plugin-cookies.md#code-examples-to-follow-along-the-service-decoration-guide) support the following attributes:
